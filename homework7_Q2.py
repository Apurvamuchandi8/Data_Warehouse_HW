    ...
    try:
        ...
        if primary_key is not None:
            ...
            if int(result[1]) > 1:
                ...
                print("Primary key uniqueness successfull")
...
with DAG(
    ...
    table = "homework3.analytics.session_summary"
    select_sql = """SELECT u.*, s.ts
    FROM homework3.raw_data.user_session_channel u
    JOIN homework3.raw_data.session_timestamp s ON u.sessionId=s.sessionId
    """
